...
-- CreateEnum
CREATE TYPE "ExtraType" AS ENUM ('CHECKBOX', 'SELECT', 'TEXT');
...
CREATE TABLE "product_extras" (
    ...
    "type" "ExtraType" NOT NULL DEFAULT 'CHECKBOX',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddForeignKey
ALTER TABLE "order_item_extras" ADD CONSTRAINT "order_item_extras_itemId_fkey" FOREIGN KEY ("itemId") REFERENCES "order_items"("id") ON DELETE CASCADE ON UPDATE CASCADE;
